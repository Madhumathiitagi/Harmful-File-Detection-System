...
class HarmfulFileDetectorApp:
    ...
    def start_scan(self):
        ...
        # Custom detect_files with logging
        ...
        for root, dirs, files in os.walk(folder):
            ...
            for file in files:
                ...
                try:
                    ...
                    self.update_logs(f"{result['file']}: {result['prediction']} (Prob: {result['probability']:.2f}) - {result['status']}\n")
    ...
    def update_stats(self):
        ...
        # Model accuracy: try to get from model
        try:
            ...
            if isinstance(artifact, dict) and 'model' in artifact:
                ...
                model = artifact
            # Assuming accuracy is not stored, set to N/A or estimate if possible
            self.model_accuracy = "N/A"  # Since we don't have test set here
        except:
            self.model_accuracy = "N/A"
